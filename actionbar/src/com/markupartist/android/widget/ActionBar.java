...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public static class ServiceAction extends AbstractAction {
        private Context mContext;
        private Intent mIntent;

        public ServiceAction(Context context, Intent intent, int drawable) {
            super(drawable);
            mContext = context;
            mIntent = intent;
        }
        ...
        public void performAction(View view) {
            try {
               ...
               Toast.makeText(mContext, "Starting a service ...", Toast.LENGTH_LONG).show();
            } catch (ActivityNotFoundException e) {
                Toast.makeText(mContext,
                        mContext.getText(R.string.actionbar_activity_not_found),
                        Toast.LENGTH_SHORT).show();
    ...
    /** Finish some activity. 
    public static class NormalAction extends AbstractAction {
        private Context mContext;

        public NormalAction(Context context, int drawable) {
            super(drawable);
            mContext = context;
        }
        ...
        public void performAction(View view) {
            try {
               ((Activity)mContext).finish(); 
                ...
                Log.e("ActionBarLib", "Activity finish ex...");
            }
        }
    }
    */        
